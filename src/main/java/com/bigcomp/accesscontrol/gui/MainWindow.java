...
final class I18n {
    ...
    private static Map<Language, Map<String, String>> buildDict() {
        ...
        zh.put("simw.col.resourceName", "资源名称");
        en.put("simw.col.resourceName", "Resource Name");
        zh.put("simw.col.groupName", "所属组名称");
        en.put("simw.col.groupName", "Group");
        ...
        zh.put("simw.action.refreshData", "刷新数据");
        en.put("simw.action.refreshData", "Refresh");
        ...
        zh.put("simw.msg.manualHowToRun", "手动模式：先加入队列，再点击“执行队列”");
        en.put("simw.msg.manualHowToRun", "Manual mode: queue events, then click Run Queue");
        zh.put("simw.msg.manualMissingSelection", "请选择：{0}");
        en.put("simw.msg.manualMissingSelection", "Please select: {0}");
        zh.put("simw.msg.manualNoBadgeUsers", "手动模拟：没有可用的徽章码用户，请先创建徽章或生成演示数据");
        en.put("simw.msg.manualNoBadgeUsers", "Manual: no users with badge code; create badges or generate demo data first");
        zh.put("simw.msg.manualNoReaders", "手动模拟：没有可用的读卡器，请先创建资源并绑定读卡器");
        en.put("simw.msg.manualNoReaders", "Manual: no badge readers; create resources and bind readers first");
        zh.put("simw.msg.manualNoResources", "手动模拟：没有可用的资源，请先创建资源或生成演示数据");
        en.put("simw.msg.manualNoResources", "Manual: no resources; create resources or generate demo data first");
        zh.put("simw.msg.manualResourceNoReader", "该资源未绑定读卡器，无法用于刷卡/更新徽章");
        en.put("simw.msg.manualResourceNoReader", "Selected resource has no reader; cannot swipe/update badge");
        zh.put("simw.msg.queueExecuted", "队列已执行");
        en.put("simw.msg.queueExecuted", "Queue executed");
        zh.put("simw.msg.queueRunSummary", "队列执行完成：成功行={0}，跳过行={1}");
        en.put("simw.msg.queueRunSummary", "Queue finished: ok={0}, skipped={1}");
        zh.put("simw.msg.queueLineSkipped", "已跳过：{0}（{1}）");
        en.put("simw.msg.queueLineSkipped", "Skipped: {0} ({1})");
        ...
        zh.put("common.exclude", "排除");
        en.put("common.exclude", "Exclude");
        ...
        zh.put("user.action.batchDelete", "批量删除用户");
        en.put("user.action.batchDelete", "Batch Delete Users");
        ...
        zh.put("user.col.profiles", "配置文件");
        en.put("user.col.profiles", "Profiles");
        ...
        en.put("user.msg.batchDeleted", "Deleted {0} users");
        zh.put("user.msg.deleteFailed", "删除用户失败：{0}");
        en.put("user.msg.deleteFailed", "Failed to delete user: {0}");
        zh.put("user.msg.batchDeleteFailItem", "  ✗ {0} -> 失败: {1}");
        en.put("user.msg.batchDeleteFailItem", "  ✗ {0} -> Failed: {1}");
        zh.put("user.msg.batchDeleteSummary", "批量删除完成！\n\n统计：\n• 成功：{0}\n• 失败：{1}\n\n失败明细：\n{2}");
        en.put("user.msg.batchDeleteSummary", "Batch deletion completed!\n\nStatistics:\n• Success: {0}\n• Failed: {1}\n\nFailure details:\n{2}");
        ...
        zh.put("resource.action.batchDelete", "批量删除资源");
        en.put("resource.action.batchDelete", "Batch Delete Resources");
        ...
        zh.put("resource.msg.confirmBatchDelete", "确定要删除选中的 {0} 个资源吗？\n该操作也会删除关联的读卡器与资源组关系。");
        en.put("resource.msg.confirmBatchDelete", "Are you sure you want to delete the selected {0} resources?\nThis operation will also delete associated badge readers and resource group associations.");
        zh.put("resource.msg.deleted", "资源删除成功");
        en.put("resource.msg.deleted", "Resource deleted successfully");
        zh.put("resource.msg.batchDeleted", "已删除 {0} 个资源");
        en.put("resource.msg.batchDeleted", "Deleted {0} resources");
        zh.put("resource.msg.deleteFailed", "删除资源失败：{0}");
        en.put("resource.msg.deleteFailed", "Failed to delete resource: {0}");
        zh.put("resource.msg.batchDeleteFailItem", "  ✗ {0} -> 失败: {1}");
        en.put("resource.msg.batchDeleteFailItem", "  ✗ {0} -> Failed: {1}");
        zh.put("resource.msg.batchDeleteSummary", "批量删除完成！\n\n统计：\n• 成功：{0}\n• 失败：{1}\n\n失败明细：\n{2}");
        en.put("resource.msg.batchDeleteSummary", "Batch deletion completed!\n\nStatistics:\n• Success: {0}\n• Failed: {1}\n\nFailure details:\n{2}");
        ...
        zh.put("group.msg.resourceInOtherGroup", "该资源已在其他资源组中：{0}");
        en.put("group.msg.resourceInOtherGroup", "This resource is already in another group: {0}");
        ...
        zh.put("profile.title.usageLimits", "使用次数限制");
        en.put("profile.title.usageLimits", "Usage Limits");
        zh.put("profile.title.priorityPolicy", "优先级规则");
        en.put("profile.title.priorityPolicy", "Priority Policy");
        ...
        zh.put("profile.col.usageLimit", "使用次数限制");
        en.put("profile.col.usageLimit", "Usage Limit");
        ...
        zh.put("profile.action.saveUsageLimit", "保存限制");
        en.put("profile.action.saveUsageLimit", "Save Limit");
        zh.put("profile.action.clearUsageLimit", "清除限制");
        en.put("profile.action.clearUsageLimit", "Clear Limit");
        zh.put("profile.action.savePriorityPolicy", "保存规则");
        en.put("profile.action.savePriorityPolicy", "Save Policy");
        zh.put("profile.action.clearPriorityPolicy", "清除规则");
        en.put("profile.action.clearPriorityPolicy", "Clear Policy");
        ...
        zh.put("profile.msg.usageSaved", "使用次数限制已保存");
        en.put("profile.msg.usageSaved", "Usage limit saved");
        zh.put("profile.msg.usageCleared", "使用次数限制已清除");
        en.put("profile.msg.usageCleared", "Usage limit cleared");
        zh.put("profile.msg.usageInvalid", "无效的数字：{0}");
        en.put("profile.msg.usageInvalid", "Invalid number: {0}");
        zh.put("profile.msg.prioritySaved", "优先级规则已保存");
        en.put("profile.msg.prioritySaved", "Priority policy saved");
        zh.put("profile.msg.priorityCleared", "优先级规则已清除");
        en.put("profile.msg.priorityCleared", "Priority policy cleared");

        zh.put("profile.limit.perUserPerDay", "每人每天上限");
        en.put("profile.limit.perUserPerDay", "Per-user per day");
        zh.put("profile.limit.perUserPerWeek", "每人每周上限");
        en.put("profile.limit.perUserPerWeek", "Per-user per week");
        zh.put("profile.limit.perUserPerMonth", "每人每月上限");
        en.put("profile.limit.perUserPerMonth", "Per-user per month");
        zh.put("profile.limit.globalPerDay", "全局每天上限");
        en.put("profile.limit.globalPerDay", "Global per day");
        zh.put("profile.limit.globalPerWeek", "全局每周上限");
        en.put("profile.limit.globalPerWeek", "Global per week");
        zh.put("profile.limit.globalPerMonth", "全局每月上限");
        en.put("profile.limit.globalPerMonth", "Global per month");
        zh.put("profile.limit.perUserPerDayPerResource", "按资源分别计数");
        en.put("profile.limit.perUserPerDayPerResource", "Count per resource (per user/day)");
        zh.put("profile.limit.perUserPerDayPerResourceHint", "同一资源单独计数（而不是按同类资源合并计数）");
        en.put("profile.limit.perUserPerDayPerResourceHint", "Count per resource (instead of aggregating by type/group)");

        zh.put("profile.priority.enabled", "启用：");
        en.put("profile.priority.enabled", "Enabled:");
        zh.put("profile.priority.enabledHint", "启用“进楼门禁”优先级规则");
        en.put("profile.priority.enabledHint", "Enable gate-within priority policy");
        zh.put("profile.priority.minutes", "分钟：");
        en.put("profile.priority.minutes", "Minutes:");
        zh.put("profile.priority.buildings", "适用建筑：");
        en.put("profile.priority.buildings", "Buildings:");
        zh.put("profile.priority.hint", "不选择建筑表示对全部建筑生效；多选请按 Ctrl/Shift");
        en.put("profile.priority.hint", "No building selected means apply to all; multi-select with Ctrl/Shift");

        zh.put("profile.limit.short.perUserPerDay", "每人/天={0}");
        en.put("profile.limit.short.perUserPerDay", "perUser/day={0}");
        zh.put("profile.limit.short.perUserPerWeek", "每人/周={0}");
        en.put("profile.limit.short.perUserPerWeek", "perUser/week={0}");
        zh.put("profile.limit.short.perUserPerMonth", "每人/月={0}");
        en.put("profile.limit.short.perUserPerMonth", "perUser/month={0}");
        zh.put("profile.limit.short.globalPerDay", "全局/天={0}");
        en.put("profile.limit.short.globalPerDay", "global/day={0}");
        zh.put("profile.limit.short.globalPerWeek", "全局/周={0}");
        en.put("profile.limit.short.globalPerWeek", "global/week={0}");
        zh.put("profile.limit.short.globalPerMonth", "全局/月={0}");
        en.put("profile.limit.short.globalPerMonth", "global/month={0}");

        zh.put("profile.details.title", "配置文件详情");
        en.put("profile.details.title", "Profile Details");
        zh.put("profile.details.name", "名称");
        en.put("profile.details.name", "Name");
        zh.put("profile.details.rightCount", "访问权条目数：{0}");
        en.put("profile.details.rightCount", "Access rights: {0}");
        zh.put("profile.details.noRights", "无访问权条目");
        en.put("profile.details.noRights", "No access rights");
        zh.put("profile.details.selectRightHint", "请选择一条访问权以查看时间过滤详情");
        en.put("profile.details.selectRightHint", "Select an access right to view time filter details");
        zh.put("profile.details.group", "资源组");
        en.put("profile.details.group", "Resource group");
        zh.put("profile.details.groupSecurity", "安全级别");
        en.put("profile.details.groupSecurity", "Security level");
        zh.put("profile.details.groupResourceCount", "资源数量");
        en.put("profile.details.groupResourceCount", "Resource count");
        zh.put("profile.details.timeFilter", "时间过滤");
        en.put("profile.details.timeFilter", "Time filter");
        zh.put("profile.details.noTimeFilter", "未设置时间过滤（默认允许全部）");
        en.put("profile.details.noTimeFilter", "No time filter set (allow all)");
        zh.put("profile.details.years", "年份");
        en.put("profile.details.years", "Years");
        zh.put("profile.details.months", "月份");
        en.put("profile.details.months", "Months");
        zh.put("profile.details.daysOfMonth", "日期");
        en.put("profile.details.daysOfMonth", "Days of month");
        zh.put("profile.details.daysOfWeek", "星期");
        en.put("profile.details.daysOfWeek", "Days of week");
        zh.put("profile.details.timeRanges", "时间段");
        en.put("profile.details.timeRanges", "Time ranges");
        zh.put("profile.details.usageByGroup", "按资源组使用次数限制");
        en.put("profile.details.usageByGroup", "Usage limits by group");
        zh.put("profile.details.usageByType", "按资源类型使用次数限制");
        en.put("profile.details.usageByType", "Usage limits by resource type");
        zh.put("profile.details.priorityPolicy", "优先级规则");
        en.put("profile.details.priorityPolicy", "Priority policy");
        zh.put("profile.details.priorityEnabled", "启用");
        en.put("profile.details.priorityEnabled", "Enabled");
        zh.put("profile.details.priorityMinutes", "门禁前置时间(分钟)");
        en.put("profile.details.priorityMinutes", "Gate-within minutes");
        zh.put("profile.details.priorityBuildings", "适用建筑");
        en.put("profile.details.priorityBuildings", "Buildings");
        ...
        zh.put("log.field.startDate", "开始日期：");
        en.put("log.field.startDate", "Start Date:");
        zh.put("log.field.endDate", "结束日期：");
        en.put("log.field.endDate", "End Date:");
